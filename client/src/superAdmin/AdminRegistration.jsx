...
function SignUp() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/api/v1/admin/register', form);
          ...
          <div className={styles.button}>
            <form className={styles.landingForm} onSubmit={handleSignup}>
              ...
              <div className={styles.btnDiv}>
                <button type="submit" className={styles.btnSubmit}>Register Admin</button>
              </div>

              <div className={styles.signupDiv}>
                <p className={styles.paragraph}>Admin Registration</p>
