...
import ProtectedAdminRoute from "./ProtectedRoutes/ProtectedRouteAdmin";
import ProtectedUserRoute from "./ProtectedRoutes/ProtectedRoute";
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/superadmindash"
              element={
                <ProtectedRouteSuperAdmin element={<SuperAdminDashboard />} />
              }
            />
            <Route
              path="/adminregister"
